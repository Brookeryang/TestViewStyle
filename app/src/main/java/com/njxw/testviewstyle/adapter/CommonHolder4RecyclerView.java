...
import com.njxw.testviewstyle.BaseAppcation;
import com.njxw.testviewstyle.MainActivity;
import com.njxw.testviewstyle.utils.GlideImageLoader;
import com.njxw.testviewstyle.utils.GlideImageUtils;
...
public class CommonHolder4RecyclerView extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public CommonHolder4RecyclerView setImageViewImage(Context mContext,@IdRes int imageViewId, @DrawableRes int drawableId) {
     ...
     * @return
     */
    public CommonHolder4RecyclerView setImageViewImage( Context mContext,@IdRes int imageViewId, String url) {
        ImageView imageView = getView(imageViewId);
